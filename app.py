...
# rplacing above line with below line to import Model from inference
...
if not os.listdir(path_to_directory):
    ...
    url = "https://ai4b-public-nlu-nlg.objectstore.e2enetworks.net/indic2en.zip"
    ...
    zipfile.extractall("C:/Users/braje/OneDrive/Desktop/content/indicTrans/models/v3")
    print("Unziped completed")
...
# RestorePuncts() basically call the server again and again on a fixed time interval
...
@app.route("/louie", methods=["GET"])
def louie():
    ta_sents = [
        "आप कैसे हैं",
    ]
    translated = indic2en_model.batch_translate(ta_sents, "hi", "en")
    return translated
