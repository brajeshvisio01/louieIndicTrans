...
class Model:
    def __init__(self, expdir):
        ...
        # this is taking time so focus on this method only
        obj = time.gmtime(0)
        ...
        self.translator = Translator(
            f"{expdir}/final_bin", f"{expdir}/model/checkpoint_best.pt", batch_size=1
        )
    ...
    def batch_translate(self, batch, src_lang, tgt_lang):
        # print("inside batch_translate")
        # https://www.geeksforgeeks.org/python-assert-keyword/ for assert
        # https://www.w3schools.com/python/ref_func_isinstance.asp isinstance() docs
        ...
        # print(f"Translation is {self.translator.translate()}")
